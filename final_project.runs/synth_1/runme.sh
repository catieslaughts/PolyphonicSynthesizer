...
HD_PWD='P:/19summer/engs031/PG17/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synth_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synth_shell.tcl
