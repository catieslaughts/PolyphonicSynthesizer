...
HD_PWD='P:/19summer/engs031/PG17/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log synth_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source synth_shell.tcl -notrace
