...
#
# Generated by Vivado on Sun Aug 18 16:16:00 -0400 2019
...
# Script info
echo -e "dds_compiler_0.sh - Script generated by export_simulation (Vivado v2018.3.1 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="P:/19summer/engs031/PG17/final_project/final_project.cache/compile_simlib/activehdl"
  fi
